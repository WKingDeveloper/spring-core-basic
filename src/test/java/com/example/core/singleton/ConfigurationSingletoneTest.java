...
public class ConfigurationSingletoneTest {
    ...
    void configurationTest() {
        ...
        MemberServiceImpl memberSeervice = ac.getBean("memberService", MemberServiceImpl.class);
        OrderServiceImpl orderSerivce = ac.getBean("orderService", OrderServiceImpl.class);
        MemberRepository memberRepository = ac.getBean("memberRepository", MemberRepository.class);

        MemberRepository memberRepository1 = memberSeervice.getMemberRepository();
        ...
        assertThat(memberSeervice.getMemberRepository()).isSameAs(memberRepository);
